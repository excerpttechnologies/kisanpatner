          ...
          <div className="container" style={{ marginTop: "20px", maxWidth: "1340px" }}>
            <div className="project-slider row">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/images/home1/projects/2.webp" alt="Web Design & Development" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/service/erp21.webp" alt="ERP Solutions" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/images/home1/projects/e.jfif" alt="Ecommerce Solutions" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/service/lms.webp" alt="LMS Solutions" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
          ...
          <div className="container" style={{ maxWidth: "1340px" }}>
            <div className="project-slider row">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/images/home1/projects/5.webp" alt="Digital Marketing" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/images/home1/projects/4.webp" alt="Cyber Security" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/images/home1/projects/7.webp" alt="Data Analytics & Science" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
              ...
              <div className="col-lg-3 mb-4">
                ...
                >
                  <div className="img-wrapper">
                    <img src="/images/home1/projects/3.webp" alt="Mobile App Development" width="400" height="300" loading="lazy" decoding="async" style={{ display: 'block' }} />
                  </div>
                  <div className="info d-flex flex-column align-items-center justify-content-center">
                    <h6 className="heading-6" style={{ marginLeft: "70px" }}>
