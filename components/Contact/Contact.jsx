        ...
        <div className="container">
          <div className="page-info">
            ...
            <h6 className="heading-6">
              <Link href="/">Home</Link> / <Link href="#">Contact</Link>
            </h6>
          </div>
        </div>
      </section>
      ...
      <section className="get-in-touch">
        ...
        <div className="get-in-touch-cards">
          ...
          <div className="contact-card transition-all duration-150 ease-in-out hover:shadow-lg">
            ...
            <h3>Phone Number</h3>
            <p>
              <Link href="tel:+916364657660">+91 63646 57660</Link>
              <br />
              <Link href="tel:+919900502404">+91 99005 02404</Link>
            </p>
          </div>
          ...
          <div className="contact-card transition-all duration-150 ease-in-out hover:shadow-lg">
            ...
            <h3>Send us mail</h3>
            <p>
              <Link href="mailto:info@excerptech.com">info@excerptech.com</Link>
            </p>
          </div>
        </div>
      </section>
