  ...
  return (
    <div id="footer">
      <section
        ...
        id="footer"
      >
        <div className="footer-body" style={{backgroundColor:"black",padding:"10px"}}>
          <div className="container responsive_ele">
            <div className="row g-4">
              <div style={{backgroundColor:"white"}} className="col-md-6 col-12 col-xl-4">
                <div className="about-company" style={{ marginTop: "10px", height: "fit-content"}}>
                  ...
                  <div className="content">
                    ...
                    <div className="socials" style={{padding:"10px",marginTop:"10px"}}>
                      <ul>
                        <li>
                          <Link href="https://www.facebook.com/Excerptech" target="_blank" rel="noopener noreferrer">
                            <i className="fa-brands fa-facebook-f"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="https://www.linkedin.com/company/excerptech" target="_blank" rel="noopener noreferrer">
                            <i className="fa-brands fa-linkedin-in"></i>
                          </Link>
                        </li>
                        <li>
                          <Link href="https://www.instagram.com/excerpt_technologies/?igsh=Z3k5OXozNDIzZHps" target="_blank" rel="noopener noreferrer">
              ...
              <div className="col-md-6 col-xl-4">
                <div className="wrapper responsive_ey">
                  ...
                  <ul>
                    <br />
                    <li>
                      <Link href="/Staticwebsite">Web Design & Development</Link>
                    </li>
                    ...
                    <li>
                      <Link href="/ecommerce">Ecommerce Solutions</Link>
                    </li>
              ...
              <div className="col-md-6 col-xl-4" style={{ marginLeft: "" }}>
                  ...
                  <div className="d-flex contact">
                    ...
                    <div className="info">
                      <div className="paragraph">
                        <Link href="tel:+916364657660" className="contact-link">+91 63646 57660</Link>
                      </div>
                      <div className="paragraph">
                        <Link href="tel:+919900502404" className="contact-link">+91 99005 02404</Link>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="d-flex contact">
                    ...
                    <div className="info">
                      <div style={{ marginTop: "10px" }}>
                        <Link href="mailto:info@excerptech.com" className="paragraph contact-link">
                          info@excerptech.com
                        </Link>
                      </div>
                    </div>
            ...
            <div className="footer-bottom">
              <div className="d-flex justify-content-center justify-content-md-between align-items-center">
                <div className="paragraph">
                  <span style={{ textAlign: "center" }}>© Excerpt Technologies 2025</span>
