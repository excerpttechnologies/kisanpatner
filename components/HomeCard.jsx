...
//                     <div className="homecard-service-card transition-all duration-150 ease-in-out hover:shadow-lg">
//                       <div 
//                         className="homecard-card-image" 
//                         onClick={() => handleImageClick(card.link)}
//                         style={{ cursor: 'pointer', width: '40rem', height: '80rem' }}
//                       >
...
//                           style={{ display: 'block', aspectRatio: '400 / 380',width: '100%', height: '100%',objectFit: 'cover',objectPosition: 'center' }}
//                         />
//                       </div>
...
const router = useRouter();
  ...
  const intervalRef = useRef(null); // JS-safe (Next.js JSX)

  const cards = [
    { img: "brochure/ai_chatbot.webp", title: "AI Chatbot Services", link: "/webdesign" },
    { img: "brochure/crm.webp", title: "CRM Solutions", link: "/Crm" },
    { img: "brochure/digital.webp", title: "Digital Marketing", link: "/DigitalMarketing" },
    { img: "brochure/dyanamic.webp", title: "Dynamic Website", link: "/Dyanamicwebsite" },
    { img: "brochure/e-comm.webp", title: "E-commerce Solutions", link: "/Ecommerce" },
    { img: "brochure/e-learning.webp", title: "E-learning Solutions", link: "/Elearning" },
    { img: "brochure/erp.webp", title: "ERP Solutions", link: "/Erp" },
    { img: "brochure/geeky.webp", title: "WhatsApp Bulk Messaging", link: "/Geekychat" },
    { img: "brochure/lms-1.webp", title: "LMS Solutions", link: "/Lms" },
    { img: "brochure/powerbi.webp", title: "Power BI Solutions", link: "/Dataanalytics" },
    { img: "brochure/static_web.webp", title: "Static Website", link: "/Staticwebsite" },
    { img: "brochure/wt-ecom.webp", title: "WhatsApp E-commerce Solution", link: "/WhatsappEcommerce" },
  ];
  ...
  }, [currentIndex, totalCards, startAutoSlide]);
...
const handleImageClick = (link) => {
  ...
  return (
    <div
      className="homecard-ex-service-cards"
      style={{ backgroundImage: `url("/images/home1/exclusive-service/bg.webp")` }}
    >
      <section className="homecard-service">
        <div className="homecard-container">
          <div className="homecard-slider-container">
            <div
              className="homecard-slider-track"
