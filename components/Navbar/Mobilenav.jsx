                        ...
                        >
                            <ul style={{
                                ...
                                <li style={{ marginBottom: "12px" }}>
                                        <Link href="/" style={{ fontSize: "18px" }} onClick={handleNavClick}>
                                        <b>HOME</b>
                                    </Link>
                                </li>
                                ...
                                <li style={{ marginBottom: "12px" }}>
                                    ...
                                    >
                                        <Link href="/services" style={{ fontSize: "18px" }} onClick={handleNavClick}>
                                            <b>SERVICES</b>
                                        </Link>
                                        <div
                                        ...
                                        >
                                            ...
                                            <div style={{ marginBottom: '10px' }}>
                                                ...
                                                {isWebDesignDropdownOpen && (
                                                    ...
                                                    >
                                                        <Link href="/Staticwebsite" style={{ fontSize: "15px", display: 'block', marginBottom: '18px' }} onClick={handleNavClick}>
                                                            Static Websites
                                                        </Link>
                                                        <Link href="/Dyanamicwebsite" style={{ fontSize: "15px", display: 'block', marginBottom: '18px' }} onClick={handleNavClick}>
                                                            Dynamic Websites
                                                        </Link>
                                                        <Link href="/Customizedwebsites" style={{ fontSize: "15px", display: 'block' }} onClick={handleNavClick}>
                                                            Customized Websites
                                                        </Link>
                                                    </div>
                                                )}
                                ...
                                <li style={{ marginBottom: "12px" }}>
                                    <Link href="/portfolio" style={{ fontSize: "18px" }} onClick={handleNavClick}>
                                        <b>PORTFOLIO</b>
                                    </Link>
                                </li>
                                <li style={{ marginBottom: "12px" }}>
                                    <Link href="/contact" style={{ fontSize: "18px" }} onClick={handleNavClick}>
                                        <b>CONTACT</b>
                                    </Link>
                                </li>
                                ...
                                {isLoggedIn && (
                                    <li style={{ marginBottom: "12px" }}>
                                        <Link href="/dashboard" style={{ fontSize: "18px", color: "#007bff" }} onClick={handleNavClick}>
                                            <b>ADMIN</b>
                                        </Link>
                                    </li>
                                )}
                                ...
                                <li style={{ marginBottom: "12px" }}>
                                    <Link href="/careers" style={{ color: "blue", fontSize: "18px" }} onClick={handleNavClick}>
                                        <b>CAREERS </b> 
                                    </Link>
                                </li>
                            </ul>
