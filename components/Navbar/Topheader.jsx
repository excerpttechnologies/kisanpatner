...
//               <a href="mailto:info@excerptech.com">
//                 <i className="fa-solid fa-envelope"></i>
//                 <b style={{ marginLeft: "5px" }}>info@excerptech.com</b>
//               </a>
...
//             <span style={{ marginLeft: "-50px" }}>
//               {isLoggedIn ? (
//                 <button className="user-account" onClick={handleLogout}>
//                   <i className="fa-solid fa-sign-out"></i> Logout
//                 </button>
//               ) : (
//                 <a href="/login" className="user-account">
...
const Topheader = ({ onLogout }) => {
  ...
  // ✅ Handle scroll (this is fine in useEffect)
  useEffect(() => {
    const handleScroll = () => {
      setIsScrolled(window.scrollY > 50);
    };
        ...
        <div className={`nav-content ${isScrolled ? "fixed-navbar" : ""}`}>
          <div className="paragraph notification">
            <span style={{ marginLeft: "80px" }}>
              ...
              <a href="tel:+916364657660" style={{ marginLeft: "20px" }}>
                <i className="fa-solid fa-phone"></i>
                <span style={{ marginLeft: "4px" }}>+91 63646 57660</span>
              </a>
            </span>
